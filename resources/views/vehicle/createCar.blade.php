...
<body class="bg-dark">
  ...
  <div class="container bg-light my-5 p-2 form-control">
    <form action="<?= url('/register/car/store') ?>" method="post">
      ...
      <div class="row g-3">
        ...
        <div class="col-md-6">
          <label for="carBoard" class="form-label fw-bold">Board</label>
          <input type="text" class="form-control" name="carBoard" id="carBoard" placeholder="mail">
        </div>
        ...
        <div class="col-6">
          <a href="indexCar" class=" btn btn-danger padding-top">CANCEL</a>
        </div>
